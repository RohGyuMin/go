...
> ⭐ **관점**: 이건 보통의 *"공유 문서형 AI 시스템"이 아니라 "아바타형·월드형 AI 경험"*으로
> 봐야 합니다. 시스템을 **읽는** 게 아니라 **들어가 겪는다**. 아래 세 축은 그 경험을 실현하는
> 수단이며, 마이크로월드가 그 중심입니다. → **[관점 문서](docs/vision-avatar-world.md)** ·
> 체험: [`microworlds/bfs-world/`](microworlds/bfs-world/)
